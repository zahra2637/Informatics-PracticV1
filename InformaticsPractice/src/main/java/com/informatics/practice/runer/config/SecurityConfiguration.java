...
import com.informatics.practice.app.common.security.Sanitizer;
...
public class SecurityConfiguration {
    ...
    SecurityFilterChain config (HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity.authorizeRequests().antMatchers("swagger-ui/**","/swagger-resources/**","swagger-ui.html/**", "/v3/api-docs", "/v3/api-docs/**", "actuator/**").permitAll()
